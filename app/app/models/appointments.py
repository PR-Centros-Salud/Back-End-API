...
from sqlalchemy import Date, Time, SmallInteger, Integer, DateTime, Column, String, ForeignKey
...
class Appointment(BaseTable):
    ...
    patient = relationship("Client", back_populates="appointment")
...
class LaboratoryAppointment(Appointment):
    ...
    laboratory_service_id = Column(Integer, ForeignKey("laboratory_service.id"), nullable=False)
    laboratory_service = relationship("LaboratoryService", back_populates="laboratory_appointment")